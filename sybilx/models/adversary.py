...
class AlignmentMLP(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.model = nn.Sequential(
            ...
            nn.LayerNorm(512) if args.replace_batchnorm_with_layernorm else nn.BatchNorm1d(512),
            nn.ReLU(inplace=True),
            nn.Linear(512, 256),
            nn.LayerNorm(256) if args.replace_batchnorm_with_layernorm else nn.BatchNorm1d(256),
            nn.ReLU(inplace=True),
