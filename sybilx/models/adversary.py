...
class AlignmentMLP(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.model = nn.Sequential(
            ...
            nn.LayerNorm(512) if args.replace_batchnorm_with_layernorm else nn.BatchNorm1d(512, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True),
            nn.ReLU(inplace=True),
            nn.Linear(512, 256),
            nn.LayerNorm(256) if args.replace_batchnorm_with_layernorm else nn.BatchNorm1d(256, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True),
            nn.ReLU(inplace=True),
