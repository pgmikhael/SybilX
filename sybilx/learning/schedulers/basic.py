...
class ReduceLROnPlateau(optim.lr_scheduler.ReduceLROnPlateau):
    ...
    def __init__(self, optimizer, args):
        super().__init__(optimizer, patience= args.patience, factor= args.lr_decay, mode = 'min')
...
class CosineAnnealingWarmRestarts(optim.lr_scheduler.CosineAnnealingWarmRestarts):
    ...
    '''
    def __init__(self, optimizer, args):
        super().__init__(optimizer, T_0 = args.cosine_annealing_period, T_mult = args.cosine_annealing_period_scaling)